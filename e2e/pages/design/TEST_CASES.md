...
| 204 | Catching a point first locks a marquee gesture to points-only for the rest of the drag; catching a handle/segment first unlocks catching everything, including a point that enters the box afterward |  ✅  |            —             |

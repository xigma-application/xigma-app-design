...
| 240 | Starting a Lasso drag directly on top of an existing vertex still starts a lasso stroke instead of dragging that vertex — a dedicated tool intercepts the click before any vertex-drag resolver sees it                                                                                                                                                                                                                                                      |  ✅  | ✅ `vector-edit.spec.ts` |

...
| 619 | Wrap in new section (header button, More actions, Object menu, ⌘S) wraps top-level layers in a new selected section 25px larger than them on every side; it is not offered for layers inside a frame, group or section, nor for a selected section                                                                                   |  ✅  |                                                        ✅ `wrap-in-section.spec.ts`                                                        |

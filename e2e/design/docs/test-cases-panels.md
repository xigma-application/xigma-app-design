...
| 607 | A selection of different panel types (frame, rectangle, boolean) shows the Mixed panel with only the sections and header buttons every selected type has (was: empty panel)                                                                                                          |  ✅  |                                                         ✅ `mixed-panel.spec.ts`                                                          |

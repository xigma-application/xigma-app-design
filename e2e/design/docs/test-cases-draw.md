...
| 646 | Outline stroke (⌥⌘O) on a dashed line (and a dashed, profiled, dynamic or brush rectangle) outlines the drawn dashes, not a solid band                                                                                                                                         |  ✅  | ✅ `outline-as-stroke.spec.ts` |

...
export const MIN_SCROLLBAR_THUMB_PX = 32;
...
export const SCROLLBAR_RANGE_PADDING_PX = 0;
export const SCROLLBAR_THICKNESS_PX = 10;
...
export const ZOOM_ANIMATION_DURATION_MS = 400;
export const AUTO_LAYOUT_REORDER_ANIMATION_DURATION_MS = 200;

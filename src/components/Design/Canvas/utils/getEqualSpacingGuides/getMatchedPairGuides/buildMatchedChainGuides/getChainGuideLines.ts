...
export const getChainGuideLines = (active: TEdges, geometry: TChainGeometry, axis: TMatchedChainAxis): TDistanceGuideLine[] => {
  const { activeCentre, activeCross, centreLineFar, spanFar, spanNear } = geometry;

  return axis === 'vertical'
    ? [
        { dashed: false, x1: activeCross, x2: activeCross, y1: activeCentre, y2: centreLineFar },
    ...
    : [
        { dashed: false, x1: activeCentre, x2: centreLineFar, y1: activeCross, y2: activeCross },

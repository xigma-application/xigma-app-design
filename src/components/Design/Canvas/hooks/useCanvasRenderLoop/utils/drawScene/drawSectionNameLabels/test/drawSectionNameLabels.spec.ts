...
describe('drawSectionNameLabels', () => {
  ...
  it('should draw nothing when there are no section nodes', () => {
    // before
    drawSectionNameLabels(gl, program, buffer, imageContext, [buildFrame()], refsWith(null), 200, 150, IDENTITY_VIEWPORT);
  ...
  it('should draw every section node', () => {
    ...
    drawSectionNameLabels(gl, program, buffer, imageContext, [section], refsWith(null), 200, 150, IDENTITY_VIEWPORT);
  ...
  it('should skip the section currently being renamed inline', () => {
    ...
    drawSectionNameLabels(gl, program, buffer, imageContext, [section], refsWith(section.id), 200, 150, IDENTITY_VIEWPORT);

...
describe('drawPerNodeSelectionOutlines', () => {
  ...
  it('should additionally draw the start-offset handle for a selected path-text node', () => {
    ...
    // before
    drawPerNodeSelectionOutlines(gl, program, buffer, [pathText], 100, 100, IDENTITY_VIEWPORT, null);
  ...
  it('should not draw the start-offset handle for an ordinary (non-path) text node', () => {
    ...
    // before
    drawPerNodeSelectionOutlines(gl, program, buffer, [straightText], 100, 100, IDENTITY_VIEWPORT, null);

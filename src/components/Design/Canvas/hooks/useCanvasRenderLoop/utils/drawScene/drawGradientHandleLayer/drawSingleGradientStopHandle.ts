...
export const STOP_HANDLE_BACKDROP_SIZE = 24;
export const STOP_HANDLE_BACKDROP_FILL = '#cacaca';
export const STOP_HANDLE_BORDER_SIZE = 20;
export const STOP_HANDLE_BORDER_STROKE = '#ffffff';
export const STOP_HANDLE_SWATCH_SIZE = 19;

export const drawSingleGradientStopHandle = (

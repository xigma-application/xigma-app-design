...
describe('drawSceneVectorNode', () => {
  ...
  it('should draw the node normally when there is no snapshot map at all', () => {
    ...
    // before
    drawSceneVectorNode(gl, program, buffer, node, null, null, null, 200, 150, IDENTITY_VIEWPORT);
  ...
  it('should draw the node normally when the snapshot maps exist but have no entry for this node', () => {
    ...
    // before
    drawSceneVectorNode(gl, program, buffer, node, dragSnapshots, resizeSnapshots, rotateSnapshots, 200, 150, IDENTITY_VIEWPORT);
  ...
  it('should draw the frozen drag snapshot instead of the live node when one exists for this node’s id', () => {
    ...
    // before
    drawSceneVectorNode(gl, program, buffer, node, dragSnapshots, null, null, 200, 150, IDENTITY_VIEWPORT);
  ...
  it('should draw the frozen resize snapshot instead of the live node when one exists for this node’s id', () => {
    ...
    // before
    drawSceneVectorNode(gl, program, buffer, node, null, resizeSnapshots, null, 200, 150, IDENTITY_VIEWPORT);
  ...
  it('should draw the frozen rotate snapshot instead of the live node when one exists for this node’s id', () => {
    ...
    // before
    drawSceneVectorNode(gl, program, buffer, node, null, null, rotateSnapshots, 200, 150, IDENTITY_VIEWPORT);
  ...
  it('should prefer the drag snapshot over a resize snapshot when both happen to be present for the same node', () => {
    ...
    // before
    drawSceneVectorNode(gl, program, buffer, node, dragSnapshots, resizeSnapshots, null, 200, 150, IDENTITY_VIEWPORT);
  ...
  it('should prefer the resize snapshot over a rotate snapshot when both happen to be present for the same node', () => {
    ...
    // before
    drawSceneVectorNode(gl, program, buffer, node, null, resizeSnapshots, rotateSnapshots, 200, 150, IDENTITY_VIEWPORT);

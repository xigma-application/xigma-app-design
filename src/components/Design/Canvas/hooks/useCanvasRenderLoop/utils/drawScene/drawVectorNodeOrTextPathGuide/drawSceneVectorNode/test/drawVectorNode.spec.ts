...
const buildContext = (
  ...
  buffer: WebGLBuffer,
  faceBufferCache: WeakMap<{ x: number; y: number }[], WebGLBuffer>,
  ...
  canvasWidth: 200,
  gl,
  imageContext: { faceBufferCache, isAlphaWriteEnabled: false, strokeBufferCache } as TDrawSceneContext['imageContext'],
  program,

...
describe('drawSceneNodes', () => {
  it('should draw nothing when there are no nodes', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, [], 100, 100, IDENTITY_VIEWPORT, new Map(), null, null);
  ...
  it('should draw a filled rect for every node', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, nodes, 100, 100, IDENTITY_VIEWPORT, new Map(), null, null);
  ...
  it('should draw a filled polygon for a polygon node', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, [polygon], 100, 100, IDENTITY_VIEWPORT, new Map(), null, null);
  ...
  it('should draw a filled star for a star node', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, [star], 100, 100, IDENTITY_VIEWPORT, new Map(), null, null);
  ...
  it('should draw a textured quad for a media node', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, [media], 100, 100, IDENTITY_VIEWPORT, new Map(), null, null);
  ...
  it('should draw a batched glyph quad for a text node', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, [text], 100, 100, IDENTITY_VIEWPORT, new Map(), null, null);
  ...
  it('should draw nothing for a path node when it has no outline style', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, [path], 100, 100, IDENTITY_VIEWPORT, new Map(), null, null);
  ...
  it('should draw a stroke-only ellipse outline for a selected path node, not a filled shape', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, [path], 100, 100, IDENTITY_VIEWPORT, new Map([['a', 'selected']]), null, null);
  ...
  it('should draw a thick outline for a hovered path node', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, [path], 100, 100, IDENTITY_VIEWPORT, new Map([['a', 'hover']]), null, null);
  ...
  it('should draw a thin segment for a line node instead of a filled rect', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, [line], 100, 100, IDENTITY_VIEWPORT, new Map(), null, null);
  ...
  it('should draw a stroked vector node from its segments', () => {
    ...
    // before
    drawSceneNodes(gl, program, buffer, IMAGE_CONTEXT, [vector], 100, 100, IDENTITY_VIEWPORT, new Map(), null, null);

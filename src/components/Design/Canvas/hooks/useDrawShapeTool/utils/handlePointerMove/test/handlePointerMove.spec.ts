...
describe('handlePointerMove', () => {
  ...
  it('should update the draft shape and alignment guide as the pointer moves', () => {
    // mock
    const refs = createCanvasRefs();
    ...
    // result
    expect(refs.draftRef.current).toMatchObject({ fill: '#00ff00', height: 110, type: NodeType.frame, width: 100, x: 20, y: 20 });

...
export const nudgeMap = (dispatch: AppDispatch, refs: TCanvasRefs): TKeyMap[] => [
  ...
  createNudgeKeyMap(dispatch, refs, -NUDGE_STEP, 0, shortcuts.nudgeLeftAlt),
  createNudgeKeyMap(dispatch, refs, NUDGE_STEP, 0, shortcuts.nudgeRightAlt),
  createNudgeKeyMap(dispatch, refs, 0, -NUDGE_STEP, shortcuts.nudgeUpAlt),
  createNudgeKeyMap(dispatch, refs, 0, NUDGE_STEP, shortcuts.nudgeDownAlt),
  ...
  createNudgeKeyMap(dispatch, refs, -NUDGE_STEP_LARGE, 0, shortcuts.nudgeLeftAltLarge),
  createNudgeKeyMap(dispatch, refs, NUDGE_STEP_LARGE, 0, shortcuts.nudgeRightAltLarge),
  createNudgeKeyMap(dispatch, refs, 0, -NUDGE_STEP_LARGE, shortcuts.nudgeUpAltLarge),
  createNudgeKeyMap(dispatch, refs, 0, NUDGE_STEP_LARGE, shortcuts.nudgeDownAltLarge),
];

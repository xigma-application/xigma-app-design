...
describe('handlePointerDown', () => {
  ...
  it('should ignore a non-primary button press entirely', () => {
    ...
    // before
    handlePointerDown(canvas, pointerEvent(10, 10, { button: 1 }), store.dispatch, store, IDENTITY_VIEWPORT, startRef, candidateShapesRef);
  ...
  it('should clear the selection, snapshot the pointer-down point, and capture the pointer', () => {
    ...
    // before
    handlePointerDown(canvas, pointerEvent(50, 60), store.dispatch, store, IDENTITY_VIEWPORT, startRef, candidateShapesRef);

...
import { armAutoLayoutPaddingOnPointerDown } from './armResolvers/armAutoLayoutPaddingOnPointerDown';
...
import { armSmartSelectionSuggestionOnPointerDown } from './armResolvers/armSmartSelectionSuggestionOnPointerDown';
...
import { armVectorEraseOnPointerDown } from './armResolvers/armVectorEraseOnPointerDown';
...
export const ARM_RESOLVERS = [
  ...
  armGradientRotateOnPointerDown,
  armAddGradientStopOnPointerDown,

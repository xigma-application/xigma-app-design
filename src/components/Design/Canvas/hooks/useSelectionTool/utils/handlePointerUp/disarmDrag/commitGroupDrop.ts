...
export const commitGroupDrop = (dispatch: AppDispatch, selectedIds: string[], canvasRefs: TCanvasRefs): void => {
  ...
  const isNewGridInsertUnderAutoPlacement = isGridDrop && !isRepositioningExistingGridChild && isGridFrameTarget && targetGridAutoPlacement;

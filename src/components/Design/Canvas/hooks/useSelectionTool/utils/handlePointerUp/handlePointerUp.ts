...
import { remapVectorFaceFillsAfterGesture } from '../vectorFaceFillRemap/remapVectorFaceFillsAfterGesture';
...
export const handlePointerUp = (
  ...
  remapVectorFaceFillsAfterGesture(dispatch, selectionRefs);

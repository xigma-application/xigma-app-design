...
import { useViewMenuZoomToPreviousFrameClick } from '../useViewMenuZoomToPreviousFrameClick';
...
describe('useViewMenuZoomToPreviousFrameClick', () => {
  beforeEach(() => {
  ...
  it('should fit the previous frame when called', () => {
    ...
    // before
    const { result } = renderHook(() => useViewMenuZoomToPreviousFrameClick(), { wrapper });

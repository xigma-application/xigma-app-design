...
import { useViewMenuZoomOutClick } from '../useViewMenuZoomOutClick';
...
describe('useViewMenuZoomOutClick', () => {
  it('should step the zoom out when called', () => {
    // mock
    ...
    // before
    const { result } = renderHook(() => useViewMenuZoomOutClick(), { wrapper });

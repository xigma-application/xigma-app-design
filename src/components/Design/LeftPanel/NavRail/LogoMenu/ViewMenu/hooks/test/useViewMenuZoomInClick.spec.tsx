...
import { useViewMenuZoomInClick } from '../useViewMenuZoomInClick';
...
describe('useViewMenuZoomInClick', () => {
  it('should step the zoom in when called', () => {
    // mock
    ...
    // before
    const { result } = renderHook(() => useViewMenuZoomInClick(), { wrapper });

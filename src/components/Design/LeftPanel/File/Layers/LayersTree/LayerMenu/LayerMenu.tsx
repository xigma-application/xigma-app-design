...
// components
import { PopoverCompound, TVirtualAnchor } from 'shared';
      ...
      <PopoverPrimitive.Portal>
        ...
        >
          ...
          <PopoverItem
            ...
            withCheck={false}
          />
          <PopoverItem disabled label={t(NODE_MENU_COPY_PASTE_AS_KEY)} withCheck={false} />
          <PopoverItem disabled label={t(NODE_MENU_SEND_TO_MAKE_KEY)} withCheck={false} />
          <PopoverItem disabled label={t(NODE_MENU_ADD_MOTION_KEY)} withCheck={false} />
          <PopoverSeparator />
          <PopoverItem disabled label={t(NODE_MENU_MOVE_TO_PAGE_KEY)} withCheck={false} />
          <PopoverItem
            disabled
          ...
          />
          <PopoverItem
            label={t(NODE_MENU_RENAME_KEY)}
            onClick={onRename}
            shortcut={KEYBOARD_SHORTCUTS.renameLayer.join('')}
            withCheck={false}
          />
          <PopoverItem disabled label={t(NODE_MENU_FLATTEN_KEY)} shortcut={KEYBOARD_SHORTCUTS.flatten.join('')} withCheck={false} />
          <PopoverItem
            disabled
            ...
            withCheck={false}
          />
          <PopoverItem disabled label={t(NODE_MENU_USE_AS_MASK_KEY)} withCheck={false} />
          <PopoverSeparator />
          <PopoverItem
            disabled
          ...
          <PopoverItem
            ...
            withCheck={false}
          />
          <PopoverItem disabled label={t(NODE_MENU_PLUGINS_KEY)} withCheck={false} />
          <PopoverItem disabled label={t(NODE_MENU_WIDGETS_KEY)} withCheck={false} />
          <PopoverSeparator />
          <PopoverItem

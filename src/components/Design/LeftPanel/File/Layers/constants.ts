...
export const NODE_ROW_LOCK_TOOLTIP_KEY = `${translationNameSpace}.lockTooltip`;
...
export const NODE_ROW_VISIBILITY_TOOLTIP_KEY = `${translationNameSpace}.visibilityTooltip`;

...
import { TBooleanNode, TEllipseNode, TFrameNode, TLineNode, TRectangleNode, TSceneNode, TSectionNode } from 'types/design/types';

export type TAppearanceNode = TBooleanNode | TFrameNode | TRectangleNode | TSectionNode;

export type TStyledNode = TAppearanceNode | TEllipseNode | TLineNode;

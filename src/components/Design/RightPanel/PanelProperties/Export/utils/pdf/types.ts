...
import { TEllipseNode, TFrameNode, TPolygonNode, TRectangleNode, TStarNode, TTextNode } from 'types/design/types';

export type TPdfShapeNode = TFrameNode | TRectangleNode | TEllipseNode | TPolygonNode | TStarNode;

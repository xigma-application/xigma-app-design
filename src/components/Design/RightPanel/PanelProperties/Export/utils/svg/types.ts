...
import { TEllipseNode, TFrameNode, TLineNode, TPolygonNode, TRectangleNode, TStarNode } from 'types/design/types';

export type TSvgShapeNode = TFrameNode | TRectangleNode | TEllipseNode | TPolygonNode | TStarNode | TLineNode;

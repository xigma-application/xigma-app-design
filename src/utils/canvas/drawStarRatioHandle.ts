...
import { getStarRatioHandlePosition } from './ratio/star/getStarRatioHandlePosition';
import { rotatePoint } from 'utils/math/rotatePoint';

export const drawStarRatioHandle = (
  ...
  const position = getStarRatioHandlePosition(bounds, points, ratio, cornerRadius, flipX, flipY);

...
describe('drawVectorGradientFill', () => {
  ...
  it('should pass the paint’s own radiusRatio for a diamond paint', () => {
    // mock
    const gl = createGlMock();
    const program = {} as WebGLProgram;
    const buffer = {} as WebGLBuffer;
    ...
    drawVectorGradientFill(
      ...
      null,
      faces,
      { ...GRADIENT_PAINT, radiusRatio: 0.4, type: 'gradient-diamond' },
      100,
      100,
      IDENTITY_VIEWPORT,
      false,
  ...
  it('should ignore radiusRatio for a linear paint, always passing 1', () => {
    // mock
    const gl = createGlMock();
    const program = {} as WebGLProgram;
    const buffer = {} as WebGLBuffer;

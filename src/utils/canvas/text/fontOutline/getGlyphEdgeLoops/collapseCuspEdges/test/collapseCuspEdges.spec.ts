...
const loop: TLoopEdge[] = [
  ...
  { start: { x: 1180.0263671875, y: 572.68603515625 }, end: { x: 1181.1, y: 571.6 }, tangentStart: null, tangentEnd: null },
  { start: { x: 1181.1, y: 571.6 }, end: { x: 1182.2, y: 570.5 }, tangentStart: null, tangentEnd: null },
  { start: { x: 1182.2, y: 570.5 }, end: { x: 1183.3, y: 569.4 }, tangentStart: null, tangentEnd: null },
  { start: { x: 1183.3, y: 569.4 }, end: { x: 1179.7666015625, y: 572.68603515625 }, tangentStart: null, tangentEnd: null },
];
...
it('collapses a near-duplicate cusp bridge into a single miter point', () => {
  ...
  console.log('miter point', curveIn.end);
});

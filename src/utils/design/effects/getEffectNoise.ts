// others
import { DEFAULT_NOISE_DENSITY, DEFAULT_NOISE_SIZE } from 'constant/effect';

// types
import { EffectNoiseType } from 'types/design/enums';
import { TEffect } from 'types/design/types';

export type TEffectNoise = { density: number; noiseSize: number; noiseType: EffectNoiseType };

...
type TResult = { setStopPosition: TFunc<[string, number]>; stops: TEditableGradientStop[] };

const renderUseSetStopPosition = (onChange = vi.fn()): { hook: RenderHookResult<TResult, unknown>; onChange: ReturnType<typeof vi.fn> } => {

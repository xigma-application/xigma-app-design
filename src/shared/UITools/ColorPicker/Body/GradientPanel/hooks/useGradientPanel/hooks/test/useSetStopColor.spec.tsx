...
type TResult = { setStopColor: TFunc<[string, TColorPickerValue]>; stops: TEditableGradientStop[] };

const renderUseSetStopColor = (onChange = vi.fn()): { hook: RenderHookResult<TResult, unknown>; onChange: ReturnType<typeof vi.fn> } => {
